using Certcer.Application.Features.ExtendedAttributes.Commands.AddEdit;
using Certcer.Application.Features.ExtendedAttributes.Queries.Export;
using Certcer.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using Certcer.Client.Extensions;
using Certcer.Client.Infrastructure.Managers.ExtendedAttribute;
using Certcer.Domain.Contracts;
using Certcer.Domain.Enums;
using Certcer.Shared.Constants.Application;
...
namespace Certcer.Client.Shared.Components
{
        ...
        where TId : IEquatable<TId>
    {
        ...
        private readonly Func<GetAllExtendedAttributesByEntityIdResponse<TId, TEntityId>, object> SortById = response => response.Id;
        private readonly Func<GetAllExtendedAttributesByEntityIdResponse<TId, TEntityId>, object> SortByType = response => response.Type;
        private readonly Func<GetAllExtendedAttributesByEntityIdResponse<TId, TEntityId>, object> SortByKey = response => response.Key;
        private readonly Func<GetAllExtendedAttributesByEntityIdResponse<TId, TEntityId>, object> SortByValue = response => response.Type switch
        {
        ...
        private readonly Func<GetAllExtendedAttributesByEntityIdResponse<TId, TEntityId>, object> SortByExternalId = response => response.ExternalId;
        private readonly Func<GetAllExtendedAttributesByEntityIdResponse<TId, TEntityId>, object> SortByGroup = response => response.Group;
        private readonly Func<GetAllExtendedAttributesByEntityIdResponse<TId, TEntityId>, object> SortByDescription = response => response.Description;
        private readonly Func<GetAllExtendedAttributesByEntityIdResponse<TId, TEntityId>, object> SortByIsActive = response => response.IsActive;
