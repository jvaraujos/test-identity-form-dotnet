using Certcer.Application.Features.DocumentTypes.Commands.AddEdit;
using Certcer.Application.Features.DocumentTypes.Queries.GetAll;
using Certcer.Client.Extensions;
using Certcer.Client.Infrastructure.Managers.Misc.DocumentType;
