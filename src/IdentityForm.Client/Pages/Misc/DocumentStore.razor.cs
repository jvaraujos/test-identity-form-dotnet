using Certcer.Application.Features.Documents.Commands.AddEdit;
using Certcer.Application.Features.Documents.Queries.GetAll;
using Certcer.Application.Requests.Documents;
using Certcer.Client.Extensions;
using Certcer.Client.Infrastructure.Managers.Misc.Document;
...
namespace Certcer.Client.Pages.Misc
{
