using Certcer.Application.Interfaces.Chat;
using Certcer.Application.Models.Chat;
using Certcer.Application.Responses.Identity;
using Certcer.Client.Extensions;
using Certcer.Client.Infrastructure.Managers.Communication;
using Certcer.Shared.Constants.Application;
using Certcer.Shared.Constants.Storage;
...
namespace Certcer.Client.Pages.Communication
{
