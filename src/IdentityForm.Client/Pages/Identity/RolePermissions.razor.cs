using AutoMapper;
using Certcer.Application.Requests.Identity;
using Certcer.Application.Responses.Identity;
using Certcer.Client.Extensions;
using Certcer.Client.Infrastructure.Managers.Identity.Roles;
using Certcer.Client.Infrastructure.Mappings;
...
namespace Certcer.Client.Pages.Identity
{
